...
- [ideation](plugins/ideation/README.md) - Evidence-gated planning interviews that turn brain dumps into contracts and implementation specs, with critic-reviewed plans, autopilot execution, and a retro learning loop
