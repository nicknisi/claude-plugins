...
- [essentials](plugins/essentials/README.md) - Essential agents and skills for Claude Code workflows - git commits, code simplification, security audits, verified multi-lens code review, thermo-nuclear code-quality review, Socratic tutoring, prototyping, diff explainers, session handoffs, and link reading.
