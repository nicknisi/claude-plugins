...
# If no argument, searches for specs and prompts you to select
/execute-spec
```
...
Tasks persist in `~/.claude/tasks` and sync across sessions, enabling:

**Resume work across sessions:**

```bash
# Start with task tracking (ID from tasks-manifest.md)
...
# Terminal 1
CLAUDE_CODE_TASK_LIST_ID=my-project-1706012345 claude
# Works on Component A

# Terminal 2 (simultaneously)
CLAUDE_CODE_TASK_LIST_ID=my-project-1706012345 claude
# Works on Component B (if independent)
```
